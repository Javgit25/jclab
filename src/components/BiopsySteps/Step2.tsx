...
interface Step2Props {
  ...
  ihqTejido?: string;
  ihqVidriosQty?: number;
  onIhqTejidoChange?: (value: string) => void;
  onIhqVidriosQtyChange?: (value: number) => void;
  onNext: () => void;
  onPrev: () => void;
  onFinishRemito?: () => void;
    ...
    <div style={{
      ...
      <div style={{ flex: 1, padding: '12px 16px 20px 16px', overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
        <div style={{
          ...
          {/* Configuración específica para Inmunohistoquímica */}
          {tissueType === 'Inmunohistoquímica' && (
            <div style={{
              marginTop: '16px',
              padding: '16px',
